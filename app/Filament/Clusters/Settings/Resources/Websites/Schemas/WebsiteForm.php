    ...
    public static function configure(Schema $schema): Schema
    {
        ...
        $state['name'] ?? 'Sosial Media'
                ...
                ->schema([
                    ...
                    ->directory('web')
                    ->getUploadedFileNameForStorageUsing(
        fn(TemporaryUploadedFile $file): string => 'hero_' . date('His_dmY') . '.' . pathinfo($file->getClientOriginalName(), PATHINFO_EXTENSION)
                )
                    ->openable()
                    ->downloadable()
                    ->imageEditor()
                    ...
                    ->directory('web')
                    ->getUploadedFileNameForStorageUsing(
        fn(TemporaryUploadedFile $file): string => 'about_' . date('His_dmY') . '.' . pathinfo($file->getClientOriginalName(), PATHINFO_EXTENSION)
                )
                    ->openable()
                    ->downloadable()
                    ->imageEditor()
